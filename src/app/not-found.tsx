    ...
    <>
      ...
      <main id="main-content" className="flex flex-1 flex-col items-center justify-center px-4 py-24 text-center">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <Link
            href="/"
            className="flex min-h-[48px] items-center justify-center rounded-full border border-charcoal/20 px-6 text-base font-semibold text-charcoal hover:bg-charcoal/5"
          >
            Back to Home
          </Link>
          <Link
